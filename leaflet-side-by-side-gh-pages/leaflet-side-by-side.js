(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  // end fix for Leaflet 1.9 -----------------------
    ...
    _updateClip: function () {
      ...
      // Update divider position on the screen
      this._divider.style.left = dividerX + 'px';
      this.fire('dividermove', {x: dividerX});
  
      // Define the clip paths for both layers:
      // For the first layer (left side of divider)
      var clipLeft = 'rect(' + [nw.y, clipX, se.y, nw.x].join('px,') + 'px)';
      // For the second layer (right side of divider)
      var clipRight = 'rect(' + [nw.y, se.x, se.y, clipX].join('px,') + 'px)';
  
      // Apply the clip effect to the left layer (left side of the divider)
      if (this._leftLayer) {
          this._leftLayer.getPane().style.clip = clipLeft; // Clip the left layer
      }
  
      // Apply the clip effect to the right layer (right side of the divider)
      if (this._rightLayer) {
          // This is where we modify the clip for the right layer to be the inverse of the left layer
